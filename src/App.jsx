...
import { 
  ...
  Search, Heart, Settings, Grid, Smartphone, Wifi, Bell, Check, Shield, User, AlertCircle, Unlock, LockKeyhole
} from 'lucide-react';
...
const FlipView = ({ pages, coverUrl, backCoverUrl, onClose, title }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] w-screen h-screen flex flex-col items-center justify-center bg-[#0f172a]/98 backdrop-blur-xl overflow-hidden animate-fade-in">
        ...
        {/* TAMBAH 'touch-none' DI SINI SUPAYA JARI TAK SCROLL WEBSITE */}
        <div className="flex-1 w-full flex items-center justify-center p-2 md:p-4 overflow-hidden touch-none">
            ...
            {isReady && (
                <HTMLFlipBook 
                    ...
                    // --- SETTING PENTING UNTUK SWIPE ---
                    mobileScrollSupport={false} // <--- WAJIB FALSE
                    useMouseEvents={true}       // Benarkan jari
                    swipeDistance={10}          // Lebih sensitif (sentuh sikit dah gerak)
      ...
      <div className="z-10 relative flex flex-col items-center w-full max-w-sm md:max-w-md">
        ...
        {!pinMode && !successMode && !isRequesting && requestStatus !== "denied" && (
          <div className="flex flex-row gap-4 md:gap-6 animate-slide-up">
            ...
            {/* VISITOR BUTTON (The Master Switch Logic) */}
            <button 
                onClick={handleVisitorClick} // Klik terus masuk kalau OFF
